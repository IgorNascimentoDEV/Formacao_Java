...
public class TestaAluno {
	...
	public static void main(String[] args) {
		...
		Aluno Nascimento = new Aluno("Igor Nascimento", 315489);
		System.out.println("Nascimento esta matriculado?");
		System.out.println(javaColecoes.estaMatriculado(Nascimento));

		System.out.println(a1.equals(Nascimento));
	}
